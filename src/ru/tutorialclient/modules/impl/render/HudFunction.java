...
import ru.tutorialclient.Initilization;
...
import ru.tutorialclient.util.font.styled.StyledFont;
...
import ru.tutorialclient.util.render.SmartScissor;
...
import static ru.tutorialclient.modules.impl.render.HudFunction.Status.*;
...
//        final float x = 5;
//        final float y = 5;
//        final float titleWidth = Fonts.msBold[15].getWidth(gradientText.getString() + title) + 6;
...
//
//        Fonts.msBold[15].drawString(stack, gradientText, x + 3, y + Fonts.msBold[15].getFontHeight() / 2f - 0.5f, -1);
//        Fonts.msBold[14].drawString(stack, title, x + Fonts.msBold[15].getWidth(gradientText.getString()) + 3.5f, y + Fonts.msBold[14].getFontHeight() / 2f + 0.3f, rgba(200, 200, 200, 255));
//    }
