...
import ru.tutorialclient.util.BetterText;
...
import static ru.tutorialclient.util.render.RenderUtil.Render2D.drawFace;
...
public class HUD2 extends Function {
    ...
    private void renderWatermark(MatrixStack matrixStack, int offset, boolean glowing, boolean shadow) {
        ...
        int width = 80;
        int height = 13;
        RenderUtil.Render2D.drawShadow(x,y,width,height,10,ColorUtil.getColorStyle(0),ColorUtil.getColorStyle(270));
        RenderUtil.Render2D.drawRoundedCorner(x,y,width,height,4,ColorUtil.rgba(20,20,20,255));
        Fonts.msBold[14].drawCenteredString(matrixStack,"TutorialClient / " + Minecraft.debugFPS,45,11,-1);
    }
